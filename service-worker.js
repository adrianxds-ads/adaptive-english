const CACHE='ae-campaign1-v2.7.1';
const ASSETS=['./','./index.html','./adrian-visual-system.js','./lessons.js','./keys.js','./app.js','./campaign-01.json','./manifest.webmanifest','./icon.svg'];
