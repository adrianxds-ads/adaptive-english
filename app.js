...
const DISCOVERY_CARDS=[
  ...
  {number:28,id:"must_should_detective_mother",releasedOn:"2026-09-20",title:"DETECTIVE / MADRE",front:"MUST HAVE o SHOULD HAVE?",back:"DETECTIVE → MUST HAVE · MADRE REGAÑANDO → SHOULD HAVE",formula:"PISTAS / DEDUCCIÓN → MUST HAVE | REPROCHE / CONSEJO PASADO → SHOULD HAVE",cue:"MUST = misterio resuelto · SHOULD = sermón."}
];
